...
GenericAppMsgNdp::GenericAppMsgNdp(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->numPaketToSend = 0;
    this->isSender = false;
...
GenericAppMsgNdp::GenericAppMsgNdp(const GenericAppMsgNdp& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
bool GenericAppMsgNdp::getIsSender() const
{
...
bool GenericAppMsgNdp::getIsReceiver() const
{
...
bool GenericAppMsgNdp::getIsLongFlow() const
{
...
GenericAppMsgNdpDescriptor::GenericAppMsgNdpDescriptor() : omnetpp::cClassDescriptor("inet::GenericAppMsgNdp", "omnetpp::cPacket")
{
...
std::string GenericAppMsgNdpDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    GenericAppMsgNdp *pp = (GenericAppMsgNdp *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getNumPaketToSend());
        case 1: return bool2string(pp->getIsSender());
        case 2: return bool2string(pp->getIsReceiver());
        case 3: return bool2string(pp->getIsLongFlow());
        case 4: return bool2string(pp->getServerClose());
        default: return "";
    }
}
...
bool GenericAppMsgNdpDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    GenericAppMsgNdp *pp = (GenericAppMsgNdp *)object; (void)pp;
    switch (field) {
        case 0: pp->setNumPaketToSend(string2long(value)); return true;
        case 1: pp->setIsSender(string2bool(value)); return true;
        case 2: pp->setIsReceiver(string2bool(value)); return true;
        case 3: pp->setIsLongFlow(string2bool(value)); return true;
        case 4: pp->setServerClose(string2bool(value)); return true;
