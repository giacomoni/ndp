...
#include "MessageDispatcherNdp.h"
#include "inet/common/ProtocolTag_m.h"
#include "inet/linklayer/common/InterfaceTag_m.h"

namespace inet {

Define_Module(MessageDispatcherNdp);

void MessageDispatcherNdp::initialize()
{
...
void MessageDispatcherNdp::arrived(cMessage *message, cGate *inGate SENDOPTIONS_ARG, simtime_t t)
{
    Enter_Method_Silent();
...
cGate *MessageDispatcherNdp::handlePacket(Packet *packet, cGate *inGate)
{
...
cGate *MessageDispatcherNdp::handleMessage(Message *message, cGate *inGate)
{
...
void MessageDispatcherNdp::handleRegisterService(const Protocol& protocol, cGate *out, ServicePrimitive servicePrimitive)
{
...
void MessageDispatcherNdp::handleRegisterProtocol(const Protocol& protocol, cGate *in, ServicePrimitive servicePrimitive)
{
...
void MessageDispatcherNdp::handleRegisterInterface(const InterfaceEntry &interface, cGate *out, cGate *in)
{
