...
#ifndef COMMON_MESSAGEDISPATCHERNDP_H_
#define COMMON_MESSAGEDISPATCHERNDP_H_
 ...
 */
class INET_API MessageDispatcherNdp : public cSimpleModule, public IProtocolRegistrationListener, public IInterfaceRegistrationListener
{
  public:
    class Key
    {
      ...
      public:
        ...
        bool operator<(const MessageDispatcherNdp::Key& other) const {
        ...
        friend std::ostream& operator<<(std::ostream& out, const MessageDispatcherNdp::Key& foo);
    };
...
std::ostream& operator<<(std::ostream& out, const MessageDispatcherNdp::Key& foo) {
