...
#ifndef NETWORKLAYER_IPV4_IPV4FRAGBUFNDP_H_
#define NETWORKLAYER_IPV4_IPV4FRAGBUFNDP_H_
...
class INET_API Ipv4FragBufNdp
{
  ...
  public:
     ...
     * 10..30 seconds or so.
     */
    void purgeStaleFragments(IcmpNdp *icmpModule, simtime_t lastupdate);
