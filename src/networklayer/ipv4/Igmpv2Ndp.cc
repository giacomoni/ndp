...
void Igmpv2Ndp::initialize(int stage)
{
...
void Igmpv2Ndp::receiveSignal(cComponent *source, simsignal_t signalID, cObject *obj, cObject *details)
{
    Enter_Method_Silent();
...
void Igmpv2Ndp::multicastGroupJoined(InterfaceEntry *ie, const Ipv4Address& groupAddr)
{
...
void Igmpv2Ndp::multicastGroupLeft(InterfaceEntry *ie, const Ipv4Address& groupAddr)
{
    ASSERT(ie && ie->isMulticast());
    ASSERT(groupAddr.isMulticast());
...
void Igmpv2Ndp::configureInterface(InterfaceEntry *ie)
{
...
void Igmpv2Ndp::deleteHostInterfaceData(int interfaceId)
{
...
void Igmpv2Ndp::deleteRouterInterfaceData(int interfaceId)
{
...
void Igmpv2Ndp::handleMessage(cMessage *msg)
{
    if (!enabled) {
...
void Igmpv2Ndp::handleRegisterService(const Protocol& protocol, cGate *out, ServicePrimitive servicePrimitive)
{
    Enter_Method("handleRegisterService");
}

void Igmpv2Ndp::handleRegisterProtocol(const Protocol& protocol, cGate *in, ServicePrimitive servicePrimitive)
{
...
void Igmpv2Ndp::processQueryTimer(cMessage *msg)
{
...
void Igmpv2Ndp::processHostGroupTimer(cMessage *msg)
{
...
void Igmpv2Ndp::processLeaveTimer(cMessage *msg)
{
...
void Igmpv2Ndp::processRexmtTimer(cMessage *msg)
{
    IgmpRouterTimerContext *ctx = (IgmpRouterTimerContext *)msg->getContextPointer();
...
void Igmpv2Ndp::startTimer(cMessage *timer, double interval)
{
    ASSERT(timer);
    cancelEvent(timer);
...
void Igmpv2Ndp::startHostTimer(InterfaceEntry *ie, HostGroupData *group, double maxRespTime)
{
    if (!group->timer) {
...
void Igmpv2Ndp::processIgmpMessage(Packet *packet)
{
    if (!verifyCrc(packet)) {
...
void Igmpv2Ndp::processQuery(InterfaceEntry *ie, Packet *packet)
{
...
void Igmpv2Ndp::processGroupQuery(InterfaceEntry *ie, HostGroupData *group, simtime_t maxRespTime)
{
...
void Igmpv2Ndp::processV2Report(InterfaceEntry *ie, Packet *packet)
{
    ASSERT(ie->isMulticast());
...
void Igmpv2Ndp::processLeave(InterfaceEntry *ie, Packet *packet)
{
    ASSERT(ie->isMulticast());
...
void Igmpv2Ndp::sendQuery(InterfaceEntry *ie, const Ipv4Address& groupAddr, double maxRespTime)
{
...
void Igmpv2Ndp::sendReport(InterfaceEntry *ie, HostGroupData *group)
{
...
void Igmpv2Ndp::sendLeave(InterfaceEntry *ie, HostGroupData *group)
{
    ASSERT(group->groupAddr.isMulticast() && !group->groupAddr.isLinkLocalMulticast());
...
void Igmpv2Ndp::sendToIP(Packet *msg, InterfaceEntry *ie, const Ipv4Address& dest)
{
    ASSERT(ie->isMulticast());
...
Igmpv2Ndp::RouterGroupData *Igmpv2Ndp::createRouterGroupData(InterfaceEntry *ie, const Ipv4Address& group)
{
    RouterInterfaceData *interfaceData = getRouterInterfaceData(ie);
...
Igmpv2Ndp::HostGroupData *Igmpv2Ndp::createHostGroupData(InterfaceEntry *ie, const Ipv4Address& group)
{
    HostInterfaceData *interfaceData = getHostInterfaceData(ie);
    ASSERT(interfaceData->groups.find(group) == interfaceData->groups.end());
...
Igmpv2Ndp::RouterGroupData *Igmpv2Ndp::getRouterGroupData(InterfaceEntry *ie, const Ipv4Address& group)
{
    RouterInterfaceData *interfaceData = getRouterInterfaceData(ie);
...
Igmpv2Ndp::HostGroupData *Igmpv2Ndp::getHostGroupData(InterfaceEntry *ie, const Ipv4Address& group)
{
    HostInterfaceData *interfaceData = getHostInterfaceData(ie);
    auto it = interfaceData->groups.find(group);
    return it != interfaceData->groups.end() ? it->second : nullptr;
...
void Igmpv2Ndp::deleteRouterGroupData(InterfaceEntry *ie, const Ipv4Address& group)
{
    RouterInterfaceData *interfaceData = getRouterInterfaceData(ie);
    auto it = interfaceData->groups.find(group);
    if (it != interfaceData->groups.end()) {
...
void Igmpv2Ndp::deleteHostGroupData(InterfaceEntry *ie, const Ipv4Address& group)
{
    HostInterfaceData *interfaceData = getHostInterfaceData(ie);
    auto it = interfaceData->groups.find(group);
    if (it != interfaceData->groups.end()) {
...
Igmpv2Ndp::RouterInterfaceData *Igmpv2Ndp::getRouterInterfaceData(InterfaceEntry *ie)
{
...
Igmpv2Ndp::RouterInterfaceData *Igmpv2Ndp::createRouterInterfaceData()
{
    return new RouterInterfaceData(this);
}

Igmpv2Ndp::HostInterfaceData *Igmpv2Ndp::getHostInterfaceData(InterfaceEntry *ie)
{
    int interfaceId = ie->getInterfaceId();
...
Igmpv2Ndp::HostInterfaceData *Igmpv2Ndp::createHostInterfaceData()
{
...
Igmpv2Ndp::HostGroupData::HostGroupData(Igmpv2Ndp *owner, const Ipv4Address& group)
...
Igmpv2Ndp::HostGroupData::~HostGroupData()
{
    if (timer) {
...
Igmpv2Ndp::RouterGroupData::RouterGroupData(Igmpv2Ndp *owner, const Ipv4Address& group)
    : owner(owner), groupAddr(group)
{
    ASSERT(owner);
    ASSERT(groupAddr.isMulticast());
...
Igmpv2Ndp::RouterGroupData::~RouterGroupData()
{
    if (timer) {
...
Igmpv2Ndp::HostInterfaceData::HostInterfaceData(Igmpv2Ndp *owner)
    : owner(owner)
{
    ASSERT(owner);
}

Igmpv2Ndp::HostInterfaceData::~HostInterfaceData()
{
...
Igmpv2Ndp::RouterInterfaceData::RouterInterfaceData(Igmpv2Ndp *owner)
    : owner(owner)
{
    ASSERT(owner);
...
Igmpv2Ndp::RouterInterfaceData::~RouterInterfaceData()
{
...
const std::string Igmpv2Ndp::getRouterStateString(Igmpv2Ndp::RouterState rs)
{
...
const std::string Igmpv2Ndp::getRouterGroupStateString(Igmpv2Ndp::RouterGroupState rgs)
{
...
const std::string Igmpv2Ndp::getHostGroupStateString(Igmpv2Ndp::HostGroupState hgs)
{
...
void Igmpv2Ndp::insertCrc(CrcMode crcMode, const Ptr<IgmpMessage>& igmpMsg, Packet *packet)
{
...
bool Igmpv2Ndp::verifyCrc(const Packet *packet)
{
