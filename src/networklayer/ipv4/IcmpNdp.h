...
#ifndef NETWORKLAYER_IPV4_ICMPNDP_H_
#define NETWORKLAYER_IPV4_ICMPNDP_H_
 ...
 * Icmp module.
 */
class INET_API IcmpNdp : public cSimpleModule, public IProtocolRegistrationListener
{
  protected:
