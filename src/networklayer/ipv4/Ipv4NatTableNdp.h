...
#ifndef NETWORKLAYER_IPV4_IPV4NATTABLENDP_H_
#define NETWORKLAYER_IPV4_IPV4NATTABLENDP_H_
...
class INET_API Ipv4NatTableNdp : public cSimpleModule, public NetfilterBase::HookBase
{
  protected:
