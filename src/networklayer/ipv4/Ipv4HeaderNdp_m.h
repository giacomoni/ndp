...
#ifndef __INET_IPV4HEADERNDP_M_H
#define __INET_IPV4HEADERNDP_M_H
...
/**
 * Enum generated from <tt>networklayer/ipv4/Ipv4HeaderNdp.msg:57</tt> by nedtool.
 * <pre>
 * //
 * // Ipv4 options class
 * //
...
/**
 * Enum generated from <tt>networklayer/ipv4/Ipv4HeaderNdp.msg:68</tt> by nedtool.
 * <pre>
 * //
 * // Ipv4 option types
 * //
...
/**
 * Enum generated from <tt>networklayer/ipv4/Ipv4HeaderNdp.msg:88</tt> by nedtool.
 * <pre>
 * //
...
/**
 * Class generated from <tt>networklayer/ipv4/Ipv4HeaderNdp.msg:95</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>networklayer/ipv4/Ipv4HeaderNdp.msg:99</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>networklayer/ipv4/Ipv4HeaderNdp.msg:105</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>networklayer/ipv4/Ipv4HeaderNdp.msg:114</tt> by nedtool.
 * <pre>
 * //
...
/**
 * Class generated from <tt>networklayer/ipv4/Ipv4HeaderNdp.msg:128</tt> by nedtool.
 * <pre>
 * //
...
/**
 * Class generated from <tt>networklayer/ipv4/Ipv4HeaderNdp.msg:146</tt> by nedtool.
 * <pre>
 * //
...
/**
 * Class generated from <tt>networklayer/ipv4/Ipv4HeaderNdp.msg:156</tt> by nedtool.
 * <pre>
 * //
 * // Option Structure: Stream ID
 * //
 ...
 * </pre>
 */
class Ipv4OptionRouterAlert : public ::inet::Ipv4Option
{
  protected:
    uint16_t routerAlert = 0;
...
/**
 * Class generated from <tt>networklayer/ipv4/Ipv4HeaderNdp.msg:163</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>networklayer/ipv4/Ipv4HeaderNdp.msg:184</tt> by nedtool.
 * <pre>
 * //
 ...
 * class Ipv4HeaderNdp extends NetworkHeaderBase
 * {
 ...
 * </pre>
 */
class Ipv4HeaderNdp : public ::inet::NetworkHeaderBase
{
  protected:
    short version = 4;
  ...
  private:
    void copy(const Ipv4HeaderNdp& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const Ipv4HeaderNdp&);

  public:
    Ipv4HeaderNdp();
    Ipv4HeaderNdp(const Ipv4HeaderNdp& other);
    virtual ~Ipv4HeaderNdp();
    Ipv4HeaderNdp& operator=(const Ipv4HeaderNdp& other);
    virtual Ipv4HeaderNdp *dup() const override {return new Ipv4HeaderNdp(*this);}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;
    ...
    virtual Ipv4Address& getSrcAddressForUpdate() { handleChange();return const_cast<Ipv4Address&>(const_cast<Ipv4HeaderNdp*>(this)->getSrcAddress());}
    virtual void setSrcAddress(const Ipv4Address& srcAddress);
    virtual const Ipv4Address& getDestAddress() const;
    virtual Ipv4Address& getDestAddressForUpdate() { handleChange();return const_cast<Ipv4Address&>(const_cast<Ipv4HeaderNdp*>(this)->getDestAddress());}
    virtual void setDestAddress(const Ipv4Address& destAddress);
    virtual const TlvOptions& getOptions() const;
    virtual TlvOptions& getOptionsForUpdate() { handleChange();return const_cast<TlvOptions&>(const_cast<Ipv4HeaderNdp*>(this)->getOptions());}
  ...
  public:
    ...
    virtual const Protocol *getProtocol() const override { return ProtocolGroupNdp::ipprotocol.findProtocol(getProtocolId()); }
    virtual void setProtocol(const Protocol *protocol) override { setProtocolId(static_cast<IpProtocolId>(ProtocolGroupNdp::ipprotocol.getProtocolNumber(protocol))); }
    virtual bool isFragment() const override { return getMoreFragments() || (getFragmentOffset() != 0); }
};

inline void doParsimPacking(omnetpp::cCommBuffer *b, const Ipv4HeaderNdp& obj) {obj.parsimPack(b);}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, Ipv4HeaderNdp& obj) {obj.parsimUnpack(b);}

} // namespace inet

#endif // ifndef __INET_IPV4HEADERNDP_M_H
